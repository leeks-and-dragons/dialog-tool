...
import de.leeksanddragons.tools.dialog.model.transition.RaiseEventTransition;
 ...
 */
public class RaiseEventTransitionController implements FXMLController, Initializable {
    ...
    public RaiseEventTransitionController (TransitionPaneController paneController, QuestionEntry entry, int index) {
