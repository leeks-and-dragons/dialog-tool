 ...
 */
public class FinishQuestTransitionController implements FXMLController, Initializable {
    ...
    public FinishQuestTransitionController (TransitionPaneController paneController, QuestionEntry entry, int index) {
    ...
    public void init(Stage stage, Scene scene, Pane pane) {
        addButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                FinishQuestTransition transition = new FinishQuestTransition(questName);
